...
import { Planet } from 'GameModules/Astro';
...
export const PlanetView = function({planet, children}:IPlanetViewProps) {
    ...
    return (
        <section className={c('container planet')}>
            ...
            <div className={c('illustration')}><IllustrationView size={300} astroBody={planet}/></div>
            <div className={c('description')}>
                ...
                <span className={c('cell val')}>
                    <span className={c(`label-descr t-${planet.orbitZone}`)}>
                        {planetDescriptor.getZone(planet.orbitZone)}
                    </span>
                </span>
